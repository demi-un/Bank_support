...
def start(msg):
    ...
    # Если пользователь уже зарегистрирован как клиент, показываем меню
    ...
    # Если пользователь уже зарегистрирован как сотрудник, показываем информацию о командах
    ...
    # Если пользователь не зарегистрирован, показываем меню выбора роли
    bot.send_message(
        msg.chat.id,
        "Здравствуйте! 👋\n\n"
